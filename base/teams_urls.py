...
from .views import (
    ...
    TeamLimitsView,
    TeamInviteView,
    TeamSentInvitationsListView,
    TeamInvitationResendView,
    TeamInvitationOwnerCancelView,
...
urlpatterns = [
    ...
    path('invitations/<uuid:invitation_id>/resend/', TeamInvitationResendView.as_view(), name='team-invitation-resend'),
    path('invitations/<uuid:invitation_id>/cancel/', TeamInvitationOwnerCancelView.as_view(), name='team-invitation-owner-cancel'),
    path('<uuid:team_id>/invitations/sent/', TeamSentInvitationsListView.as_view(), name='team-sent-invitations'),
